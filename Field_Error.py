...
class MyDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        static_text_1 = wx.StaticText(self, wx.ID_ANY, "Error !!")
        ...
        static_text_2 = wx.StaticText(self, wx.ID_ANY, "Cannot Predict")
        ...
        static_text_3 = wx.StaticText(self, wx.ID_ANY, "Please check all the fields")
